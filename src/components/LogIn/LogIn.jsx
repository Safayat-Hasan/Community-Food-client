                ...
                <div className="hero-content flex-col lg:flex-row-reverse md:gap-10">
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <div className="flex items-center space-x-1">
                            <div className="flex-1 h-px sm:w-16 "><hr /></div>
                            <p className="px-3 text-base">Login with social accounts</p>
                            <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"><hr /></div>
                        </div>
