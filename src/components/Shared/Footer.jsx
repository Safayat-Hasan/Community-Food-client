        ...
        <div className="mt-14">
            <footer className="footer p-10 bg-cyan-100 text-base-content">
                ...
                <nav>
                    ...
                    <a className="link link-hover">Telephone: 717-466-3504 x68556</a>
                    <a className="link link-hover">Mobile: (848) 860-5486</a>
                </nav>
                <nav>
                    <header className="footer-title">Address</header>
                    <a className="link link-hover">596 Runte Overpass</a>
                    <a className="link link-hover">North Lydia</a>
                    <a className="link link-hover">Arkansas</a>
                </nav>
                <nav>
            ...
            <div className="p-10 bg-cyan-100 text-center">
                <p>Copyright © 2023 - All right reserved by FoodHarmony</p>
            </div>
        </div>
    );
};
